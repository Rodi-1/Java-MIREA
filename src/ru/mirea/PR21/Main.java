package ru.mirea.PR21; // Объявление пакета

// Импорт классов из других файлов
import ru.mirea.PR21.ArrayElementGetter;
import ru.mirea.PR21.ArrayToListConverter;
import ru.mirea.PR21.GenericArray;
